import { CategoryType, ResultType, TeamType, WodType } from "../types/table.t";
...
export const mergeTeams = (category: CategFields, wods: WodFields[]) => {
  ...
  //@ts-ignore
  // Sort wod results
  const copyWods:WodType[] = wods ? wods.map(w => {
